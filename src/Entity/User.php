...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Articulo", mappedBy="propietario")
     */
    private $articulos;
    ...
    public function removeArticulo(Articulo $articulo): self
    {
        if ($this->articulos->contains($articulo)) {
            ...
            if ($articulo->getPropietario() === $this) {
                $articulo->setPropietario(null);
            }
        }
